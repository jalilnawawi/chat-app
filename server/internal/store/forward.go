...
func copyAttachments(ctx context.Context, tx pgx.Tx, src *forwarded, messageID, ownerID uuid.UUID) ([]Attachment, error) {
	...
	rows, err := tx.Query(ctx, `
		INSERT INTO attachments
			(id, owner_id, message_id, storage_key, name, mime, size, width, height, duration_ms, peaks,
			 thumb_key, thumb_mime, thumb_size)
		SELECT pair.new_id, $4, $5, a.storage_key, a.name, a.mime, a.size, a.width, a.height, a.duration_ms, a.peaks,
